...
declare module grunt {
    ...
    module config {
        ...
        interface ConfigModule {
            ...
            /**
             * Process a value, recursively expanding <% %> srcFiles (via the grunt.template.process method)
    ...
    module option {
        ...
        interface OptionModule {
             ...
             * Boolean options can be negated by prepending no- onto the msgid. For example:
             *
    ...
    module template {
        ...
        interface TemplateModule {
             ...
             *
             * The template argument will be processed recursively until there are no more srcFiles to process.
             *
             ...
             *
             * Inside srcFiles, the grunt object is exposed so that you can do things like:
             *     <%= grunt.template.today('yyyy') %>
             *
             * @note if the data object already has a grunt property, the grunt API will not be accessible in srcFiles.
             */
